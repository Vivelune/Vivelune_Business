                    ...
                    <form className="space-y-8 mt-4" onSubmit={form.handleSubmit(handleSubmit)}>
                        ...
                        render={({field})=>(
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea placeholder="Summarise this text: {{json httpResponse.data}}"
                                    className="min-h-[120px] font-mono text-sm"
                                    {...field}/>
                                </FormControl>

                                <FormDescription>
                                    The prompt to send to the AI assistant. Use {"{{variables}}"} for simple values or {"{{json variable}}"} to stringify objects
                                </FormDescription>
                                <FormMessage/> 
